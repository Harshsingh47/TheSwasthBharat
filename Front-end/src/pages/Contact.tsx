              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91 1234 567 891</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@swasthbharat.com</p>
                    <p className="text-gray-600">support@swasthbharat.com</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8 rounded-xl shadow-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-white px-8 py-4 rounded-lg hover:bg-blue-600 transition-colors flex items-center justify-center"
                >
